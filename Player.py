...
#         self.physics_engine = arcade.PhysicsEnginePlatformer(self.macchina2, walls = Muri.Muri_().wall_list, gravity_constant = Macchina().gravity)
...
#         self.physics_engine = arcade.PhysicsEnginePlatformer(self.macchina3, walls = Muri.Muri_().wall_list, gravity_constant = Macchina().gravity)
